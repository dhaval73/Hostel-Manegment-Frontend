        ...
        <>
            <div className="mb-4 min-w-[200px] w-full">
                ...
                <input
                    type={type}
                    id={id}
                    className={`form-input w-full px-4 py-1 border rounded-br-2xl rounded-tl-2xl border-gray-300 border-l-2 border-t-2   text-gray-700 text-lg focus:ring-blue-500 ${className} ${error && "border-red-700 border-2 outline-none"} ${type === 'number' && "[-moz-appearance:_textfield] [&::-webkit-inner-spin-button]:m-0 [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:m-0 [&::-webkit-outer-spin-button]:appearance-none"}`}
                    required={required}
